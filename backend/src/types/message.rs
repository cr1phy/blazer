...
impl ImageMessage {
    pub fn new(sender_id: Uuid, receiver_id: Uuid, image_data: Vec<u8>, caption: Option<String>) -> Self {
        Self {
            base: Message::new(sender_id, receiver_id, None, Some(MediaType::Image(image_data))),
            caption,
        }
    }
}
...
impl VideoMessage {
    pub fn new(sender_id: Uuid, receiver_id: Uuid, video_data: Vec<u8>, caption: Option<String>) -> Self {
        Self {
            base: Message::new(sender_id, receiver_id, None, Some(MediaType::Video(video_data))),
            caption,
        }
    }
}
...
impl VoiceMessage {
    pub fn new(sender_id: Uuid, receiver_id: Uuid, voice_data: Vec<u8>, duration: u64) -> Self {
        Self {
            base: Message::new(sender_id, receiver_id, None, Some(MediaType::Voice(voice_data))),
            duration,
        }
    }
}
...
impl FileMessage {
    pub fn new(sender_id: Uuid, receiver_id: Uuid, file_data: Vec<u8>, filename: String) -> Self {
        Self {
            base: Message::new(sender_id, receiver_id, None, Some(MediaType::File(file_data))),
            filename,
        }
    }
}
